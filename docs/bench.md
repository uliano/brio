...
+5 V. Both boards at 5 V. Board A's firmware today is `spi_peer` (the
phase F instrument; board C is the DUT - the ROLES OF THE AVR CAMPAIGN
INVERTED). The AVR-to-AVR PORTE link is NOT fitted;

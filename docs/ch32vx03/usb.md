...
realizes. Driver:
[brio/ch32vx03/usb.hpp](../../brio/ch32vx03/usb.hpp) (`Usbd`), with the
...
it. Reference suite: `test_vx03_usb`, the console on the probe's UART
...
USB fed 48. The reference suite is `test_vx03_usb`, whose console is
...
- **The eight parts other than the CH32V203C8.** The block is a part
  ...
  (`brio check ch32vx03`), and the suite links whole for the 32 KB tier

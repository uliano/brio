...
name. Driver: [brio/ch32vx03/dma.hpp](../../brio/ch32vx03/dma.hpp) with
...
`test_vx03_dma`, 25 verdicts in `z`, on the CH32V203C8T6 at 144 MHz with
...
- **The eight parts other than the CH32V203C8.** The request table folds
  ...
  ch32vx03`); the CH32V203RB's TIM5 rows and the smallest parts' absent

...
1.8.3. Driver: `samc21/ccl.hpp`, over `samc21/device_tables.hpp`'s CCL
probes. Family fixture `test/family_samc21/ccl.cpp` plus ten negatives
under `test/family_samc21/neg/`. Bench suite `test_samc_ccl`.

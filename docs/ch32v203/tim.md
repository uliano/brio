...
CH32V203RB. Driver:
[brio/ch32v203/tim.hpp](../../brio/ch32v203/tim.hpp). Reference suite:
`test_v203_tim`.
...
- **A pad is a REMAP COLUMN, not a per-pin selector.** AFIO_PCFR1 holds
  ...
  [afio.hpp](../../brio/ch32v203/afio.hpp), so a remap and a pad cannot
...
`test_v203_tim`, ten letters, **36 pass, 0 fail** on a CH32V203C8 at

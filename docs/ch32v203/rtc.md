...
[brio/ch32v203/rtc.hpp](../../brio/ch32v203/rtc.hpp). Reference suite:
`test_v203_rtc`.
...
`test_v203_rtc` measured the chapter on a CH32V203C8T6 with the board's
...
- **The six parts with no port C**, which bond neither the 32 kHz pads
  ...
  hardware prologue can be built (`brio check ch32v203`). What would

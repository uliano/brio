...
[brio/ch32v203/spi.hpp](../../brio/ch32v203/spi.hpp). Reference suite:
`test_v203_spi`, which talks to a peer board running `spi_peer`.
...
[afio.hpp](../../brio/ch32v203/afio.hpp)'s tables;
...
`test_v203_spi` on the CH32V203C8T6 at 144 MHz of HCLK (PB2 = 144 MHz,

...
[brio/ch32v203/crc.hpp](../../brio/ch32v203/crc.hpp), over the software
...
[ch32v203/dma.hpp](../../brio/ch32v203/dma.hpp) already has every verb
...
`test_v203_misc` measured the chapter on a CH32V203C8T6, at 96 MHz from
...
- **The eight parts other than the CH32V203C8.** The block is not a
  ...
  can be built (`brio check ch32v203`). What would measure them is a
  board.

...
Drivers: [brio/ch32v203/pwr.hpp](../../brio/ch32v203/pwr.hpp),
[brio/ch32v203/sleep.hpp](../../brio/ch32v203/sleep.hpp) and
[brio/ch32v203/bus_activity.hpp](../../brio/ch32v203/bus_activity.hpp).
Reference suite: `test_v203_sleep`.
...
`Ch32v203SleepSite<Clock, config>` is [the power model](../design/power.md)'s
...
`Ch32v203TimedSleepSite<P, Clock, config, site_config>` adds the RTC in
...
```cpp
using Site = brio::Ch32v203TimedSleepSite<P, Clock>;   // the crystal, a 1024 Hz tick
...
`test_v203_sleep` on a CH32V203C8T6 at 96 MHz from the board's crystal,

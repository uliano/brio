...
[brio/ch32v203/i2c.hpp](../../brio/ch32v203/i2c.hpp). Reference suite:
`test_v203_i2c`, which talks to a peer board running `twi_peer`.
...
`test_v203_i2c` on the CH32V203C8T6 at 96 MHz of HCLK - PB1 = 48 MHz,

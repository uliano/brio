...
[brio/ch32v203/adc.hpp](../../brio/ch32v203/adc.hpp), with the two block
engines of [brio/ch32v203/dma.hpp](../../brio/ch32v203/dma.hpp) behind
its stream. Reference suite: `test_v203_adc`.
...
`test_v203_adc`, 57 verdicts in `z`, on the CH32V203C8T6 with the PLL on
...
- **The eight parts other than the CH32V203C8.** The converter count,
  ...
  prologue can be built (`brio check ch32v203`); the 128 KB part's six

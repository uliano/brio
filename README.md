...
| `stm32f4/` | everything that knows `stm32f4xx.h` (Cortex-M4F, brio's first ARMv7-M): RCC/PLL with the regulator scale and over-drive, GPIO, USART, `Stm32f4Platform`; its NVIC and ticker are `cortexm/`'s | `kernel/`, `util/`, `cortexm/` |

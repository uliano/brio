// test_samc_nvm - the reference bench suite for samc21/nvm.hpp and
// samc21/nvm_flash.hpp.
//
...
// (samc21/nvm_flash.hpp's RwweePartition) and nothing here touches them.
//

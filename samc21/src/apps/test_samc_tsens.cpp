// test_samc_tsens - the reference bench suite for samc21/tsens.hpp, the
...
// samc21/nvm.hpp has typed all four since the NVMCTRL pass; this is the
...
void tf_datapath_width() {
    ...
    if (first_ovf != 0) {
        ...
        // number. (samc21/sdadc.hpp's converter saturates instead, so the

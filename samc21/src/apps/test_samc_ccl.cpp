// test_samc_ccl - the reference bench suite for samc21/ccl.hpp
...
void tg_latency() {
    ...
    bench.verdict("the AC's synchronized output costs the fraction to the next "
                  "edge plus TWO whole periods (docs/samc21/ac.md, re-measured "
    ...
    //
    // The lead docs/samc21/ac.md left open: a DFF clocked by the wanted
    ...
    bench.verdict("THE ANSWER docs/samc21/ac.md ASKED FOR: the comparator's own "

...
//     (docs/samc21/clock.md), and letter d is trying to see a 129 ppm
//     effect. If the crystal does not start, everything falls back to
//     OSC48M and the boot banner says so.
//   - samc21/freqm.hpp measures the 32 kHz oscillator the RTC is running
...
// (docs/samc21/clock.md). Every rate in this suite would then be reported
...
//
// OSC32KCTRL.RTCCTRL is samc21/osc32kctrl.hpp's register, and samc21/rtc.hpp
...
void ta_block() {
    ...
    // samc21/osc32kctrl.hpp, and samc21/rtc.hpp has no verb for it at all.
...
void td_frequency_correction() {
    ...
    // docs/samc21/rtc.md carries it as an open question.
    ...
    // docs/samc21/rtc.md records the discrepancy instead.

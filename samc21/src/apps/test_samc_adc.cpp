// test_samc_adc - the reference bench suite for samc21/adc.hpp.
//
...
void ta_block() {
    ...
    bench.verdict("INIT COPIED THE FACTORY CALIBRATION INTO ADC0.CALIB - "
                  "38.5.10 calls it mandatory and samc21/nvm.hpp typed the "
...
void tc_bandgap() {
    ...
    // measurement, printed and carried into docs/samc21/adc.md. What IS
...
void tf_timing() {
    ...
    // safe and one that is too tight is not - docs/samc21/adc.md says so.

...
// debug-class chapters of the SAM C21: samc21/pac.hpp (ch. 11),
// samc21/dsu.hpp (ch. 13), samc21/divas.hpp (ch. 14) and samc21/mtb.hpp
// (10.3).
//
...
void td_identity() {
    ...
    bench.verdict("and the whole DID is the one docs/samc21/vendor/README.md "
...
void th_divas_cost() {
    ...
    print(serial, "  (adopting the block as the toolchain's division is a "
                  ...
                  "take - docs/samc21/divas.md names it open, with these "

/*
 * parts/ch32v303rb.hpp
 *
 * The CH32V303RB as a table of facts: 128 KB of flash, 32 KB of SRAM, LQFP64M
 * with fifty-one pins bonded, the QingKe V4F core with its floating-point
 ...
 *
 * THE 128 KB PART. Table 2-1-1 gives this part and the CH32V303CB a smaller
 * set than the 256 KB two: three serial ports, two SPIs and no I2S, one
 * advanced-control timer and three general-purpose ones, no basic timer, no
 * RNG and no SDIO host - with the same four amplifiers and the same two DACs.
 *
 ...
 * lies usably above it (ld/ch32v303rb.ld).
 */
...
inline constexpr const char* part_name = "CH32V303RB";

 ...
 *    authority - probed, symbol by symbol, in samc21/device_tables.hpp
 ...
 *    (docs/samc21/eic.md carries it): 26.6.3 says the EIC "automatically
 ...
 *    bite. docs/samc21/eic.md carries the numbers.
 *
...
public:
     ...
     * (docs/samc21/eic.md carries the measurement); the sentence does
     * not.
     */
...
// =============================================================================
// Pad to line: samc21/device_tables.hpp is the authority
// =============================================================================
//

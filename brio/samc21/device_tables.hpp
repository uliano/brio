 ...
 *    CCL1/IN[3].
 *
 * Consumers: samc21/eic.hpp, samc21/tc.hpp, samc21/tcc.hpp, samc21/ac.hpp,
 * samc21/adc.hpp, samc21/dac.hpp, samc21/sdadc.hpp, samc21/ccl.hpp,
 * samc21/pac.hpp, samc21/dsu.hpp, samc21/mtb.hpp. Each declares the MEANING of its numbers
...
/// against (docs/samc21/tcc.md carries the decoding the bench confirmed).
...
/// selects is the AC chapter's arithmetic and lives in samc21/ac.hpp
...
/// arithmetic and not merely its pace - see samc21/tsens.hpp.
...
/// connection, so the bench decides - see docs/samc21/mtb.md. These

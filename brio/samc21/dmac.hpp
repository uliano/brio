 ...
 *    samc21/sercom.hpp's dead-block predicate, which is one line of SERCOM
 ...
 *
 * =========================================================================
 * NOT BUILT, deliberately (docs/samc21/dmac.md carries the same list):
 ...
 * channel ids in samc21/clock.hpp - the codes are READ OFF THE DEVICE
...
///
/// This DUPLICATES samc21/sercom.hpp's `sercom_count`, and the duplication

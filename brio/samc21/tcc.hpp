 ...
 * chapter at all, and were measured (docs/samc21/tcc.md carries the
 * numbers).
 *
 ...
 *    through samc21/device_tables.hpp, and a configuration that asks an
 ...
 *    the bit; docs/samc21/tcc.md carries what the bench measured happens
 *    without it.
 *
 ...
 *    at `TccFaultCapture` and in docs/samc21/tcc.md, since it is a
 ...
 *    docs/samc21/tcc.md carries the numbers; the item is left standing as
...
enum class TccRamp : uint8_t {
    ...
    /// refuses it - see docs/samc21/tcc.md for what writing it does here.
 ...
 * stated here and in docs/samc21/tcc.md.
 */
...
// =============================================================================
// Geometry and legality - samc21/device_tables.hpp is the authority
// =============================================================================
//
...
public:
     ...
     * is no workaround; the bench measured it and docs/samc21/tcc.md
     * carries the numbers.
     */
...
// =============================================================================
// Pad to waveform output: samc21/device_tables.hpp is the authority
// =============================================================================

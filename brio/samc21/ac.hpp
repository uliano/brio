 ...
 *  silicon question; docs/samc21/ac.md carries the measured answer.
 *
...
enum class AcNegative : uint8_t {
    ...
    /// REFERENCE paths do (docs/samc21/ac.md, docs/samc21/dac.md).
...
// all - lives in the reserve (samc21/device_tables.hpp), probed from the
...
public:
    ...
    /// SYNC pad output is one of the measured facts in docs/samc21/ac.md.
    static bool state() {

 ...
 * up). NOT here: the vector-table relocation VTOR would allow (VTOR
 * exists on this core, RM0444 12.1). The software reset is not here
 * either - it is stm32g0/reset.hpp's `Reset::software()`, beside the

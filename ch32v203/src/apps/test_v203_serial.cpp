// test_v203_serial - the reference bench suite for the CH32V203's USART
// chapter (RM ch. 18) beyond the console personality: the resource
// ch32v203/usart.hpp's `Usart<n>` in every mode the chapter has, and
...
void banner() {
    print(serial, crlf, "test_v203_serial - the USART chapter on ", device::part_name, crlf);

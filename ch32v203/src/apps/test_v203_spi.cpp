// test_v203_spi - the reference bench suite for the CH32V203's SPI
// chapter: ch32v203/spi.hpp over RM ch. 20, both instances, both roles,
...
void banner() {
    print(serial, crlf, "test_v203_spi - the SPI of RM ch. 20, both instances", crlf,

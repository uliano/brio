// test_v203_watchdog - the reference bench suite for the CH32V203's two
// WATCHDOGS: ch32v203/watchdog.hpp over RM ch. 7 (the independent one)
...
// a .noinit token:
//     brio run <board> w --app test_v203_watchdog --expect="->" --timeout 60
//     brio run <board> v --app test_v203_watchdog --expect="->" --timeout 60
...
void banner() {
    print(serial, crlf, "test_v203_watchdog on ", device::part_name,

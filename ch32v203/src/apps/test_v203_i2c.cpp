// test_v203_i2c - the reference bench suite for the CH32V203's I2C
// chapter: ch32v203/i2c.hpp over RM ch. 19, the host engine under its
...
void banner() {
    print(serial, crlf, "test_v203_i2c - the I2C of RM ch. 19 on I2C1 (PB6/PB7)", crlf,

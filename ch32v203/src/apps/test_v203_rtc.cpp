// test_v203_rtc - the reference bench suite for the CH32V203's REAL-TIME
// CLOCK and the backup domain around it: ch32v203/rtc.hpp over RM ch. 6
...
void th_backup() {
    ...
    // where the index is a constant (test/family_ch32v203/neg).
...
void banner() {
    print(serial, crlf, "test_v203_rtc on ", device::part_name,

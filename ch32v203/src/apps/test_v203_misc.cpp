// test_v203_misc - the reference bench suite for the CH32V203's small
// blocks: ch32v203/crc.hpp over RM ch. 5, the cyclic redundancy check
...
void banner() {
    print(serial, crlf, "test_v203_misc on ", device::part_name,

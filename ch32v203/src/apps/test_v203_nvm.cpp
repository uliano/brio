// test_v203_nvm - the reference bench suite for the CH32V203's FLASH
// MEMORY: ch32v203/nvm.hpp over RM ch. 32 (the array, the engine, the
// option bytes) and ch. 31 (the electronic signature), with
// ch32v203/nvm_flash.hpp's MainFlash - the FlashMedia in the last 4 KB
...
void banner() {
    print(serial, crlf, "test_v203_nvm on ", device::part_name,

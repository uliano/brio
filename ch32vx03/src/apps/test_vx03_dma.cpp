// test_vx03_dma - the reference bench suite for the CH32V203's DMA
// controller: ch32vx03/dma.hpp over RM ch. 11, and the two engine slots
// ch32vx03/usart.hpp grew for it.
//
...
// ===========================================================================
void banner() {
    print(serial, crlf, "test_vx03_dma - the DMA controller of RM ch. 11", crlf,

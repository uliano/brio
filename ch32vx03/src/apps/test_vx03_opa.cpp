// test_vx03_opa - the reference bench suite for the CH32V203's two
// operational amplifiers: ch32vx03/opa.hpp over RM ch. 30, read by the
// converter of ch32vx03/adc.hpp on the pad each output lands on.
//
...
// ===========================================================================
void banner() {
    print(serial, crlf, "test_vx03_opa - the two amplifiers of RM ch. 30", crlf,

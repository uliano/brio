...
bool need_self_link() {
    if constexpr (!self_link_possible) {
        print(serial,
              ...
              "(PB10/PC2/PD4/PB12) are bonded to no pin of this package "
              "(DS12992 table 12). There is no wiring of this board that "
              "could carry it: the letter is compiled out here, not merely "
              "skipped.",
              crlf);
        return false;
    }

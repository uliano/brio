// The whole of kernel/, util/ and gfx/ over this platform: every
// framework header instantiated once against Rp2350Platform, the proof
// that they compile unchanged on this family - and here, uniquely, the
// proof is taken TWICE, once through each of the two compilers this chip
// answers to, which is the strongest statement this project can make
// that nothing above the target strata knows an instruction set.

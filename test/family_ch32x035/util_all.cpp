...
// The serial port is USART2, the one instance whose default pads every
// package of the series bonds.
#include <stdint.h>
#include <string.h>
...
struct FakeFlash {
    static constexpr uint32_t erase_size = device::flash_protect_bytes;   // the 2 KB protection unit

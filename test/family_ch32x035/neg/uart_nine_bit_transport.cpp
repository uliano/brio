...
// The transport's rings carry bytes: a nine-bit frame is the resource's
// read_word()/write_word(), and a Uart of one is refused.
...
using Serial = brio::Uart<2, P, 64, 64,
                          brio::UartFormat{brio::UartBits::nine, brio::UartParity::none, brio::UartStop::one}>;
void f() {
